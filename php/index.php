    ...
    if ($con) {
        ...
        if ($result) 
        {
            ...
            //       $Message=$row[2];
                  ...
                  echo '<div style="width:fit-content; margin:auto;"><br><br><center style="font-size:20px;">Message Submited Successfully...!</center><br><br>Name: '.$name.'<br>Email: '.$email.'<br>Message: '.$message.'<br><br><button style="
                  display: flex;width: fit-content; margin: auto; padding:10px 20px; border-radius:10px; background-color:green;"><a style="text-decoration:none; font-size:15px;" href="../index.html" >OK</a></button><br></div>';
